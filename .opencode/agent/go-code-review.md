---
description: Reviews Go code for general quality, best practices, and idiomatic Go
mode: subagent
model: opencode/deepseek-v4-flash-free
---

Review the code and suggest improvements if applicable based on idiomatic Go and pest practices.

## Go Wiki: Go Code Review Comments

<table><tbody><tr><th colspan="2">Table of Contents</th></tr><tr><td><dl><dt><a href="#gofmt">Gofmt</a></dt><dt><a href="#comment-sentences">Comment Sentences</a></dt><dt><a href="#contexts">Contexts</a></dt><dt><a href="#copying">Copying</a></dt><dt><a href="#crypto-rand">Crypto Rand</a></dt><dt><a href="#declaring-empty-slices">Declaring Empty Slices</a></dt><dt><a href="#doc-comments">Doc Comments</a></dt><dt><a href="#dont-panic">Don’t Panic</a></dt><dt><a href="#error-strings">Error Strings</a></dt><dt><a href="#examples">Examples</a></dt><dt><a href="#goroutine-lifetimes">Goroutine Lifetimes</a></dt><dt><a href="#handle-errors">Handle Errors</a></dt><dt><a href="#imports">Imports</a></dt><dt><a href="#import-blank">Import Blank</a></dt><dt><a href="#import-dot">Import Dot</a></dt><dt><a href="#in-band-errors">In-Band Errors</a></dt><dt><a href="#indent-error-flow">Indent Error Flow</a></dt></dl></td><td><dl><dt><a href="#initialisms">Initialisms</a></dt><dt><a href="#interfaces">Interfaces</a></dt><dt><a href="#line-length">Line Length</a></dt><dt><a href="#mixed-caps">Mixed Caps</a></dt><dt><a href="#named-result-parameters">Named Result Parameters</a></dt><dt><a href="#naked-returns">Naked Returns</a></dt><dt><a href="#package-comments">Package Comments</a></dt><dt><a href="#package-names">Package Names</a></dt><dt><a href="#pass-values">Pass Values</a></dt><dt><a href="#receiver-names">Receiver Names</a></dt><dt><a href="#receiver-type">Receiver Type</a></dt><dt><a href="#synchronous-functions">Synchronous Functions</a></dt><dt><a href="#useful-test-failures">Useful Test Failures</a></dt><dt><a href="#variable-names">Variable Names</a></dt></dl></td></tr></tbody></table>
...
Additional comments related to testing can be found at [Go Test Comments](https://go.dev/wiki/TestComments)
...
```markdown
func F(ctx context.Context, /_ other arguments _/) {}
```
...
Also see [Initialisms](https://go.dev/wiki/CodeReviewComments#initialisms).
...
If that seems like a lot of typing, you may want to write a [table-driven test](https://go.dev/wiki/TableDrivenTests).
