...
Usage:
  youtube-summarizer summarize <url> [flags]
...
Examples:
  ...
  youtube-summarizer summarize https://youtube.com/watch?v=xyz -o summary.txt

  # Use a different model
  youtube-summarizer summarize https://example.com/blog --model gpt-4o`,
}
